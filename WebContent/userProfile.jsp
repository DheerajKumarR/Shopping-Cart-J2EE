...
<%@ page
	import="com.shop.dto.impl.*,com.shop.dto.*,com.shop.dao.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #E6F9E6;">
	...
	/* Checking the user credentials */
		...
		UserDao user = dao.getUserDetails(userName, password);
		if (user == null)
			user = new UserDao("Test User", 98765498765L, "test@gmail.com", "ABC colony, Patna, bihar", 87659, "lksdjf");
	%>
