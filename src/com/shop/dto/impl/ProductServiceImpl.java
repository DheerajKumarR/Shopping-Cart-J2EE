...
import com.shop.dto.ProductService;
...
public class ProductServiceImpl implements ProductService {
	...
	public String addProduct(String prodName, String prodType, String prodInfo, double prodPrice, int prodQuantity,
		...
		ProductDao product = new ProductDao(prodId, prodName, prodType, prodInfo, prodPrice, prodQuantity, prodImage);
	...
	public String updateProductWithoutImage(String prevProductId, ProductDao updatedProduct) {
		...
		try {
			...
			if ((k > 0) && (prevQuantity < updatedProduct.getProdQuantity())) {
				...
				List<DemandDao> demandList = new DemandServiceImpl().haveDemanded(prevProductId);

				for (DemandDao demand : demandList) {
