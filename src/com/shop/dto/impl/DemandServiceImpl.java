...
import com.shop.dto.DemandService;
...
public class DemandServiceImpl implements DemandService {
	...
	public List<DemandDao> haveDemanded(String prodId) {
		List<DemandDao> demandList = new ArrayList<DemandDao>();
		...
		try {
			...
			while (rs.next()) {
				...
				DemandDao demand = new DemandDao(rs.getString("username"), rs.getString("prodid"),
						rs.getInt("quantity"));
