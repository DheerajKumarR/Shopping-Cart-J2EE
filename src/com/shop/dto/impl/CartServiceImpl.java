...
import com.shop.dto.CartService;
...
public class CartServiceImpl implements CartService {
	...
	public String addProductToCart(String userId, String prodId, int prodQty) {
		...
		try {
			...
			if (rs.next()) {
				...
				ProductDao product = new ProductServiceImpl().getProductDetails(prodId);
				...
				if (availableQty < prodQty) {
					...
					DemandDao demandDao = new DemandDao(userId, product.getProdId(), prodQty - availableQty);
	...
	public List<CartDao> getAllCartItems(String userId) {
		List<CartDao> items = new ArrayList<CartDao>();
