...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "ElectronicsStore.alumni@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Electronics Store</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Electronics Store.<br>"
					...
					+ "<span class='greenText'>Electronics500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
